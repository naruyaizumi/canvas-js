...
export default class oldRank {
constructor(options) {
this.font = { name: options?.font?.name ?? "Manrope", path: options?.font?.path }
this.avatar = "https://cdn.discordapp.com/embed/avatars/0.png"
this.foreground = { color: "#2a2e35", opacity: 0.8 }
this.background = { type: "color", background: "#23272a" }
this.bar = { color: "#5b58f2", opacity: 1 }
this.discriminator = { data: "0000", color: "#23272a", display: false, size: 35 }
this.username = { data: "username", color: "#fff", size: 30 }
this.level = { data: 1, display: false, text: "Level", text_color: "#fff", number_color: "#fff", size: 28, data_size: 40 }
this.rank = { data: 1, display: false, text: "Rank", text_color: "#fff", number_color: "#fff", size: 28, data_size: 40 }
...
const statutes = { online: "#3ba55c", idle: "#faa61a", dnd: "#ed4245", stream: "#593695", offline: "#747f8e" }
