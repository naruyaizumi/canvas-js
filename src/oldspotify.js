...
import * as Util from '../plugins/Util.js'

export default class oldSpotify {
constructor(options) {
this.font = { name: options?.font?.name ?? "Manrope", path: options?.font?.path }
this.album = null
this.artist = null
this.background = { type: "color", background: "#23272a" }
this.bar = { background_color: "#e8e8e8", color: "#1db954" }
this._bar_width = 300
this.end = null
...
else if (progress > this._bar_width) return this._bar_width
